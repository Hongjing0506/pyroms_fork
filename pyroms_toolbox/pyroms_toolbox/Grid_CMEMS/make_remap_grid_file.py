r'''
Author: ChenHJ
Date: 2024-06-28 21:28:08
LastEditors: ChenHJ
LastEditTime: 2024-06-28 21:28:19
FilePath: /mylib/pyroms/pyroms_toolbox/pyroms_toolbox/Grid_CMEMS/make_remap_grid_file.py
Description: 
'''
import numpy as np
...
def make_remap_grid_file(grd):
    ...
    nc.Description = 'remap grid file for CMEMS'
    nc.Author = 'pyroms_toolbox.Grid_CMEMS.make_remap_grid_file'
